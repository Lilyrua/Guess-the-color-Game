var i=0
const all =["สีแดง","สีน้ำเงิน","สีเขียว","สีเหลือง","สีชมพู","สีขาว","สีดำ","สีเทา","สีน้ำตาล","สีส้ม"]
function a(){
var q = Math.floor(Math.random()*9)
console.log(q)
var r = prompt("How many rounds you want to plays.")
var num = 0
while(i==0){
var color=prompt("Let Plays")
